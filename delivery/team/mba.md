...
**Role.** Owns the **legal + government-credential critical path** (Path A), the packaging/pricing matrix, pilot-dealer onboarding, and acts as PM + UAT lead. The credential applications have approval queues on the critical path, so this role starts at week 0.
...
- **W11:** pilot go-live checklist; support/escalation; legal review of customer + dealer terms.
- **W12:** pilot onboarded staging→prod (migrated history, chosen package + mode); launch sign-off; investor demo. → **M4**.
